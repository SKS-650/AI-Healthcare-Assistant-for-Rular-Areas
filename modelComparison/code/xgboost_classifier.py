...
class XGBoostSymptomChecker:
    ...
    def fit(self, X: np.ndarray, y: np.ndarray) -> 'XGBoostSymptomChecker':
        """
        Train the model.
    ...
    def cross_validate(
        ...
        """
        scores = cross_val_score(self.model, X, y, cv=cv, n_jobs=self.n_jobs, scoring='accuracy')
    ...
    @classmethod
    def load(cls, filepath: str) -> 'XGBoostSymptomChecker':
